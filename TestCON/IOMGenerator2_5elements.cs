...
namespace ConnectionLinkTestApp
{
    ...
    //    project2 = Project.ReadProjectFromXML(@"C:\Data\\ElementRAZ88");
    //}



    internal class IOMGenerator2_5elements
    {
        ...
        private void CreateIDEAOpenModel()
        {
            ...
            openStructModel.OriginSettings.Author = "Author Rayaan Ajouz";
        ...
        private void AddRolledCSS2()
        {
            ...
            css1.Name = "HEA200";
            css1.Parameters.Add(new ParameterString() { Name = "UniqueName", Value = ideaName });
            //Q: how do you know what the exact name of the parameter should be?
        ...
        private void AddNodesToOpenModel()
        {
            ...
            Point3D pointD = new Point3D() { X = 0, Y = 0, Z = 3 };
            pointD.Name = "N4";
            pointD.Id = 4;
            ...
            Point3D pointF = new Point3D() { X = -3, Y = 0, Z = 3 };
            pointF.Name = "N6";
            pointF.Id = 6;
            openStructModel.AddObject(pointF);

            //    Point3D pointF = new Point3D() { X = 6, Y = 0, Z = 0 };
            //    pointF.name
        ...
        private void CreateIDEAOpenModelConnection()
        {
            ...
            ConnectedMember conMb1 = AddConnectedMember3point(1, 2, 1, 2, 3);
            ConnectedMember conMb2 = AddConnectedMember2point(2, 3, 2, 4, 0);
            ConnectedMember conMb3 = AddConnectedMember2point(3, 3, 2, 5, 0);
            ConnectedMember conMb4 = AddConnectedMember2point(4, 3, 2, 6, 0);
