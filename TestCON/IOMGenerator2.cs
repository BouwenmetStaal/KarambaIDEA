...
namespace ConnectionLinkTestApp
{
    ...
    internal class IOMGenerator2
    {
        ...
        private void CreateIDEAOpenModelConnection()
        {
            ...
            ConnectedMember conMb1 = AddConnectedMember3point(1, 1, 1, 2, 3);
            ConnectedMember conMb2 = AddConnectedMember2point(2, 1, 2, 4, 0);
            ConnectedMember conMb3 = AddConnectedMember2point(3, 1, 2, 5, 0);
        ...
        //ConnectedMember connectedMember = new ConnectedMember[0].IsContinuous(true);
