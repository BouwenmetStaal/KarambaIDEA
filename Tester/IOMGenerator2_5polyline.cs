...
{
	internal class IOMGenerator2_5polyline
	{
		...
		{
			Point3D pointA = new Point3D() { X = -3, Y = 0, Z = 0 };
			pointA.Name = "N1";
			pointA.Id = 1;
			openStructModel.AddObject(pointA);

			Point3D pointB = new Point3D() { X = -1, Y = 0, Z = 0 };
			pointB.Name = "N2";
			pointB.Id = 2;
			openStructModel.AddObject(pointB);

			Point3D pointC = new Point3D() { X = 0, Y = 0, Z = 0 };
			pointC.Name = "N3";
			pointC.Id = 3;
			openStructModel.AddObject(pointC);

			Point3D pointD = new Point3D() { X = 1, Y = 0, Z =0 };
			pointD.Name = "N4";
			pointD.Id = 4;
			openStructModel.AddObject(pointD);

			Point3D pointE = new Point3D() { X = 3, Y = 0, Z =0 };
			pointE.Name = "N5";
			pointE.Id = 5;
            ...
            Point3D pointG = new Point3D() { X = 3, Y = 0, Z = 3 };
            pointG.Name = "N7";
            pointG.Id = 7;
            openStructModel.AddObject(pointG);
		...
		private void CreateIDEAOpenModelConnection()
		{
            ...
            ConnectedMember conMb1 = AddConnectedMember(1, 1, 1, 2, 3, 4, 5);
            ConnectedMember conMb2 = AddConnectedMember(2, 2, 2, 6);
            ConnectedMember conMb3 = AddConnectedMember(3, 2, 4, 7);
