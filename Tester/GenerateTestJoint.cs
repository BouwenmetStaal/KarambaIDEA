       ...
       public Joint Testjoint()
        {
            ...
            new ElementRAZ(project2, 0, new LineRAZ(0, puntB, puntC), project2.crossSections[1], "Column", 1);
            new ElementRAZ(project2, 1, new LineRAZ(1, puntA, puntB), project2.crossSections[1], "Column", 1);
