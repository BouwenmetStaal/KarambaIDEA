...
namespace KarambaIDEA
{
    ...
    {
        public CreateIDEAModelBIM() : base("Export ModelBIM", "ModelBIM", "Export a Project to a ModelBIM file XML file which can be imported directly in IDEA Checkbot Application", "KarambaIDEA", "5. IDEA utilities")
        {
    ...
    {
        public CreateIDEAfileSS_OBSOLETE() : base("Create IDEA File", "Create IDEA File", "Create IDEA file", "KarambaIDEA", "5. IDEA utilities")
        {
