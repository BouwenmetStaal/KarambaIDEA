...
namespace KarambaIDEA
{
    ...
    {
        public ATemplate_WeldAllMembers() : base("Analytical Template: Welds all members", "AT: WAM", "Analytical Template: weld all members", "KarambaIDEA", "3. Analytical Templates")
        {
