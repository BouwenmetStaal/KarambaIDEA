...
namespace KarambaIDEA
{
    ...
    {
        public ATemplate_MomentResistingConnection() : base("Analytical Template: Moment resisting connection", "AT: MRC", "Analytical Template: Moment resisting connection", "KarambaIDEA", "3. Analytical Templates")
        {
