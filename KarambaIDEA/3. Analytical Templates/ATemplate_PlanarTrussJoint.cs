...
namespace KarambaIDEA._4._Analytical_Templates
{
    ...
    {
        public ATemplate_PlanarTrussJoint() : base("Analytical Template: Planar Truss Joint", "AT: PTJ", "Analytical Template: Planar Truss Joint", "KarambaIDEA", "3. Analytical Templates")
        {
