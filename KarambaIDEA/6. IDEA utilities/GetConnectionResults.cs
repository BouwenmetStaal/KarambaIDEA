...
namespace KarambaIDEA.Grasshopper
{
    ...
    {
        public ConnectionResults() : base("Connection Results", "ConResults", "Retrieve Connection Results from a calculated connection", "KarambaIDEA", "6. IDEA utilities") {}
    ...
    {
        public DeconstructItemResult() : base("Deconstruct Item Result", "DecItemResult", "Deconstruct a Connection Item Result", "KarambaIDEA", "6. IDEA utilities") { }
