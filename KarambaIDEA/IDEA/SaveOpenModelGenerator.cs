...
//        }
//        private void AddRolledCSS22(KarambaIDEA.Core.CrossSection crossSection)
//        {
//            CrossSectionParameter isection = new CrossSectionParameter();
//            isection.Id = crossSection.id;
//            find related material:
//            MatSteel material = openModel.MatSteel.First(a => a.Id == crossSection.material.id);
//            isection.Material = new ReferenceElement(material);
//            set cross section type
//            isection.Name = crossSection.name;
//            double height = crossSection.height / 1000;
//            double width = crossSection.width / 1000;
//            double tweb = crossSection.thicknessWeb / 1000;
//            double tflange = crossSection.thicknessFlange / 1000;
//            double radius = crossSection.radius / 1000;
//            CrossSectionFactory.FillWeldedI(isection, width, height, tweb, tflange);
//            CrossSectionFactory.FillShapeI(isection, height, width, width, tflange, tflange, tweb);
//            openModel.AddObject(isection);
//        }
