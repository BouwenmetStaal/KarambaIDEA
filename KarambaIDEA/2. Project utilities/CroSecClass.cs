...
namespace KarambaIDEA._0._Utilities
{
    ...
    {
        public CroSecClass() : base("CroSecClass", "CroSecClass", "Analyse Cross-section Class based on NEN-EN 1993-1-1 Table 5.2 and 5.3", "KarambaIDEA", "2. Project utilities")
        {
