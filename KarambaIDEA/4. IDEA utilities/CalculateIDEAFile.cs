...
namespace KarambaIDEA
{
    public class CalculateIDEAFile : GH_Component
    {
        ...
        {
            pManager.AddNumberParameter("Analysis", "", "", GH_ParamAccess.item);
            pManager.AddNumberParameter("Plates", "", "", GH_ParamAccess.item);
            pManager.AddNumberParameter("Welds", "", "", GH_ParamAccess.item);
            pManager.AddNumberParameter("Buckling", "", "", GH_ParamAccess.item);
            pManager.AddTextParameter("Summary", "", "", GH_ParamAccess.item);
        }
